...
def main():
    ...
    vector_search_chunks = vector_db.retrieval_process(query, embedding_model=embedding_model, top_k=3)
    keyword_search_chunks = keyword_searcher.search_by_keyword(query, vector_search_chunks);
